      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 p-6 animate-in zoom-in-95 duration-300">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            Our online checkout is temporarily unavailable. But don&apos;t
            worry! You can still connect with us on Etsy or Instagram for
            content and special requests.
          </p>
          ...
          <div className="space-y-3">
            ...
            <a
              href="https://instagram.com/onlyfansofplants_"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <p className="text-sm text-gray-500 mt-4">
            Thank you for your interest in our plants! 🌱
          </p>
        </div>
      </div>
    </div>
